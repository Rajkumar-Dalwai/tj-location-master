...
import UsedTractorBrandStateCityListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/10.UsedTractor+Brand+State+CityListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`10. Verify Page redirections for Used Tractor Brand State City Listing Page`, () => {
