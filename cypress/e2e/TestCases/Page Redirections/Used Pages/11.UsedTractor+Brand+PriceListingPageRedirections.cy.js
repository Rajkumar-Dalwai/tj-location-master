...
import UsedTractorBrandPriceListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/11.UsedTractor+Brand+PriceListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`11. Verify Page redirections for Used Tractor Brand Price Listing Page`, () => {
