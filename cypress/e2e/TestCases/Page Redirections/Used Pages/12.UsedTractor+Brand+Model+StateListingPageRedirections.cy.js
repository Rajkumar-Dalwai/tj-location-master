...
import UsedTractorBrandModelStateListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/12.UsedTractor+Brand+Model+StateListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`12. Verify Page redirections for Used Tractor Brand Model State Listing Page`, () => {
