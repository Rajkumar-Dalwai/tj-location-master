...
import UsedTractorBrandModelStateCityListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/13.UsedTractor+Brand+Model+State+CityListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`13. Verify Page redirections for Used Tractor Brand Model State City Listing Page`, () => {
