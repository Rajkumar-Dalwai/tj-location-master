...
import UsedTractorBrandStateCityPriceListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/15.UsedTractor+Brand+State+City+PriceListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`15. Verify Page redirections for Used Tractor Brand State City Price Listing Page`, () => {
