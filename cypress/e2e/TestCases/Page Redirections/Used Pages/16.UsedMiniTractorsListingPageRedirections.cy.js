...
import UsedMiniTractorsListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/16.UsedMiniTractorsListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`16. Verify Page redirections for Used Mini Tractors Listing Page`, () => {
