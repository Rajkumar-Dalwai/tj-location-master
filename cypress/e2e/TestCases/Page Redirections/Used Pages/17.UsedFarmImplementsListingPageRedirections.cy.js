...
import UsedFarmImplementsListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/17.UsedFarmImplementsListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`17. Verify Page redirections for Used Farm Implements Listing Page`, () => {
