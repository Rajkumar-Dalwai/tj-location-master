...
import UsedHarvestersListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/18.UsedHarvestersListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`18. Verify Page redirections for Used Harvesters Listing Page`, () => {
