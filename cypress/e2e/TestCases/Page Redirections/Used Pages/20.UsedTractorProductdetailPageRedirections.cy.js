...
import CertifiedUsedTractorProductdetailPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/20.CertifiedUsedTractorProductdetailPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`20. Verify Page redirections for Certified Used Tractor Product Detail Page`, () => {
