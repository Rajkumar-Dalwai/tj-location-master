...
import UsedFarmImplementsProductdetailPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/21.UsedFarmImplementsProductdetailPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`21. Verify Page redirections for Used Farm Implements Product Detail Page`, () => {
