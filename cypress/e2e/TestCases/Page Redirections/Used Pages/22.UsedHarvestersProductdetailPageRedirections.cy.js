...
import UsedHarvestersProductdetailPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/22.UsedHarvestersProductdetailPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`22. Verify Page redirections for Used Harvesters Product Detail Page`, () => {
