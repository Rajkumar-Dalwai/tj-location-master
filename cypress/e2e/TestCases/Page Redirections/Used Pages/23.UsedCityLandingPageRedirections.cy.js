...
import UsedCityLandingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/23.UsedCityLandingPages.cy';

// Object mapping for dynamic test execution
const pageRepositories = [
    { name: 'Used City Landing Page URLs', urls: UsedCityLandingPageUrls.getUsedCityLandingPageUrls() }
];
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`23. Verify Page redirections for Used City Landing Pages`, () => {
