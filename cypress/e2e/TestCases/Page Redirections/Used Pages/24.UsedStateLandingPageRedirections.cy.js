...
import UsedStateLandingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/24.UsedStateLandingPages.cy';

// Object mapping for dynamic test execution
const pageRepositories = [
    { name: 'Used State Landing Page URLs', urls: UsedStateLandingPageUrls.getUsedStateLandingPageUrls() }
];
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`24. Verify Page redirections for Used State Landing Pages`, () => {
