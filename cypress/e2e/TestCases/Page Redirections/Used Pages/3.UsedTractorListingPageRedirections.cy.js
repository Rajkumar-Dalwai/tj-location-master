...
import UsedTractorListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/3.UsedTractorListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`3. Verify Page redirections for Used Tractor Listing Page`, () => {
