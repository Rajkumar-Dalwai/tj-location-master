...
import UsedTractorBrandListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/4.UsedTractor+BrandListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`4. Verify Page redirections for Used Tractor Brand Listing Page`, () => {
