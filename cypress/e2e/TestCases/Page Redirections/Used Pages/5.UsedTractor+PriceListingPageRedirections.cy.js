...
import UsedTractorPriceListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/5.UsedTractor+PriceListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`5. Verify Page redirections for Used Tractor Price Listing Page`, () => {
