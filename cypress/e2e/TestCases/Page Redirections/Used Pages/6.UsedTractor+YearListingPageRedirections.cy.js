...
import UsedTractorYearListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/6.UsedTractor+YearListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`6. Verify Page redirections for Used Tractor Year Listing Page`, () => {
