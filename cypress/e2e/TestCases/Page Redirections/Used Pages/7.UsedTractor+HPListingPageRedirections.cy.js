...
import UsedTractorHPListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/7.UsedTractor+HPListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`7. Verify Page redirections for Used Tractor HP Listing Page`, () => {
