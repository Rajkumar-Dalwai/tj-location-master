...
import UsedTractorLocationListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/8.UsedTractor+LocationListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`8. Verify Page redirections for Used Tractor Location Listing Page`, () => {
