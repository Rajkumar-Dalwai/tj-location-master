...
import UsedTractorBrandStateListingPageUrls from '../../../Reusable-Utilities/Page Redirections/Used Pages/9.UsedTractor+Brand+StateListingPage.cy';
...
describe('Page URL Redirection Validation', () => {
    ...
    pageRepositories.forEach((repo) => {
        it(`9. Verify Page redirections for Used Tractor Brand State Listing Page`, () => {
